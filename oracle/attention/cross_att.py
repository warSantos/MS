...
from src.cross_attention import CrossAttDataHandler, CrossAttMetaLayer
...
for dataset_setup, c_set, meta_layer_name in iters:
    ...
    for fold in np.arange(1):
        ...
        data_handler = CrossAttDataHandler(DATA_SOURCE,
                                           dataset,
                                           settings[c_set],
                                           fold,
                                           n_folds,
        ...
        model = CrossAttMetaLayer(data_handler.n_labels,
        ...
        trainer = pl.Trainer(accelerator="gpu", callbacks=[model.get_stoper(epochs=max_epochs)])
